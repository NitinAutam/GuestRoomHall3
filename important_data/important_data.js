...
exports.cancel_room_pdf_link =
  "https://drive.google.com/file/d/1DwxsTCZfzEVdtUhS7x8DVoDJYJ39mvAz/preview?usp=sharing";
exports.feedback_form_link = "https://forms.gle/m63MF9T5JXg8i3Ux8";
exports.prices_pdf_link =
  "https://drive.google.com/file/d/1VOSaIhvCH-Dq4Qp_FjYOH7VdUcm6roY9/preview?usp=drive_link";
exports.rules_pdf_link =
  "https://drive.google.com/file/d/1xdI43agz38aWA97FPZ-Ty6mP_7PT_j7a/preview?usp=sharing";

exports.ameneties_heading = "4 double bed rooms and 1 triple bed room.";
exports.ameneties_sub_heading = [
  "They are well furnished rooms.",
  "The rooms feature wide-open spaces, providing ample room to relax.",
  "Additionally, they are equipped with coolers to ensure a comfortable stay.",
];

exports.rules_heading =
  "Guest rooms in Hall 3 can be booked by residents of any hall of IIT Kanpur.";
exports.rules_sub_heading = [
  "Key collection time: 10 am to 5 pm except Sunday.",
  "Key submission time: 10 am to 5 pm except Sunday.",
...
exports.subject_forget_password_email =
  "Guest Room Booking Portal - Password Reset OTP - Hall 3";
exports.notify_warden_email =
  "Guest Room Booking Portal - Request Pending - Action Required";
exports.indentor_confirmation_otp_email =
  "Guest Room Booking Portal - Booking OTP - Hall 3";
exports.warden_approval_email = (id) =>
  `Guest Room Booking Portal - Booking Request Approval [Booking ID:${id}]`;
exports.warden_rejection_email = (id) =>
  `Guest Room Booking Portal - Booking Request Rejection [Booking ID:${id}]`;
exports.payment_1_email = (id) =>
  `Confirmation: Guest Room Booking [Booking ID: ${id}`;
exports.payment_2_email = (id) =>
  `Total Payment Received: Guest Room Booking [Booking ID: ${id}]`;
exports.payment_1_confirmation_email = `Booking confirmed`;
exports.payment_2_confirmation_email = `Total payment received`;
exports.indentor_askfor_otp_email =
  "Your booking request is being processed. Please check your email for the OTP to confirm your booking.";

exports.max_number_persons_message =
  "The maximum allowable number of individuals shall not exceed ";
...
exports.indentor_details_checkbox_1 =
  "I will be held responsible if any of these information is found false. I also undertake all the financial responsibility arising out of non-payment of loss or damage to the hall properties etc. I have read the rules and regulations of the guest room/ordinary room of Hall No. 3, and visitor and I will follow the same.";
exports.indentor_details_checkbox_2 =
  "I declare my complete responsibility for the conduct of my guests throughout their stay in the Guest Room. I, hereby, submit to bear the consequences of any misconduct or damage on the part of my guest during their stay in the Guest Room.";

exports.rate_limit_request = 5;
exports.rate_limit_time = 1000;
exports.rate_limit_msg =
...
exports.validation_error = (errorMessage) =>
...
exports.email_send_error =
  "Failed to send OTP code via email. Please try again later.";
exports.email_booking_request_success =
  "Your request is pending with the warden for review. You will be notified once a decision has been made.";
...
exports.date_conflict =
  "Dates already booked by someone else. Please choose another.";
...
exports.arrival_date_error =
  "Please enter a valid arrival date in DD/MM/YYYY format.";
exports.departure_date_error =
  "Please enter a valid departure date in DD/MM/YYYY format.";
...
exports.purpose_error =
  "Purpose must only contain letters and spaces and must have at least 1 character after trimming";
exports.purpose_required_error = "Purpose is required";
exports.relationship_error =
  "Relationship must only contain letters and spaces and must have at least 1 character after trimming";
exports.relationship_array_error =
  "Relationship array must have at least one value";
exports.relationship_required = "Relationship is required";
exports.name_error =
  "Name must only contain letters and spaces and must have at least 1 character after trimming";
